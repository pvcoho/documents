...
Consent is the absence of a objection by any member of the circle. Objections are measured against the aim of the circle or the needs of our cohousing community as a whole. Personal preference is not the basis for objection. It is the responsibility of the whole circle to understand, explore and respond to an objection.
