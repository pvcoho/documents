...
TIP: The Common House Circle would affirm the purpose and responsibilities of the Kitchen Circle.
...
TIP: The Kitchen Circle is a Sub-Circle of the Common House Circle.
...
TIP: The Common House Expanded Work Circle includes the Kitchen Committee, Cook Teams, Ad Hoc Library committee, Guest Room scheduler, etc.
...
TIP: The Kitchen Committee and Cooks may meet; CH Committee may meet with all the basement coordinators to discuss new ideas for reorganizing that space, and so on.
